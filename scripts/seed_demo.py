...
def seed():
    ...
    # 5. Create completion_log.json
    # Exactly 10 completed sessions:
    # Week 2 ago: 4 sessions (under week: 2)
    # Week 1 ago: 4 sessions (under week: 2)
    # Current week: 2 sessions (under week: 1, resolving Session 1 and 2 from plan)
    completions = [
        # Week 2 ago (4 sessions)
        {
            "session_id": "demo_session_001",
            "timestamp": (monday - timedelta(days=14)).isoformat() + "T16:00:00",
            "date": (monday - timedelta(days=14)).isoformat(),
            "week": 2,
            "day": 1,
            "drills_completed": ["WARM_001", "TECH_001", "COOL_001"],
            "duration_minutes": 45,
        ...
        },
        {
            ...
            "timestamp": (monday - timedelta(days=13)).isoformat() + "T16:30:00",
            "date": (monday - timedelta(days=13)).isoformat(),
            "week": 2,
            "day": 2,
            "drills_completed": ["WARM_002", "TECH_004", "COOL_002"],
            "duration_minutes": 50,
            "difficulty": "Intermediate",
            "focus_areas": ["First Touch"]
        },
        {
            ...
            "timestamp": (monday - timedelta(days=12)).isoformat() + "T15:30:00",
            "date": (monday - timedelta(days=12)).isoformat(),
            "week": 2,
            "day": 3,
            "drills_completed": ["WARM_003", "TECH_002", "COOL_001"],
            "duration_minutes": 55,
            "difficulty": "Intermediate",
            "focus_areas": ["First Touch"]
        },
        {
            ...
            "timestamp": (monday - timedelta(days=11)).isoformat() + "T17:00:00",
            "date": (monday - timedelta(days=11)).isoformat(),
            "week": 2,
            "day": 4,
            "drills_completed": ["WARM_001", "TECH_005", "COOL_002"],
            "duration_minutes": 60,
            "difficulty": "Intermediate",
            "focus_areas": ["First Touch"]
        },
        # Week 1 ago (4 sessions)
        {
            "session_id": "demo_session_005",
            "timestamp": (monday - timedelta(days=6)).isoformat() + "T15:30:00",
            "date": (monday - timedelta(days=6)).isoformat(),
            "week": 2,
            "day": 1,
            "drills_completed": ["WARM_001", "TECH_006", "SSG_003", "COOL_001"],
            "duration_minutes": 60,
            "difficulty": "Advanced",
        ...
        },
        {
            ...
            "timestamp": (monday - timedelta(days=5)).isoformat() + "T16:30:00",
            "date": (monday - timedelta(days=5)).isoformat(),
            "week": 2,
            "day": 2,
            "drills_completed": ["WARM_003", "TECH_002", "TECH_004", "COOL_003"],
            "duration_minutes": 65,
            "difficulty": "Intermediate",
            "focus_areas": ["First Touch"]
        },
        {
            ...
            "timestamp": (monday - timedelta(days=4)).isoformat() + "T17:30:00",
        ...
        },
        {
            ...
            "timestamp": (monday - timedelta(days=3)).isoformat() + "T16:00:00",
        ...
        # Current week completed sessions (Session 1 and Session 2)
        {
            "session_id": "demo_session_009",
            "timestamp": monday.isoformat() + "T15:30:00",
        ...
        },
        {
            ...
            "timestamp": (monday + timedelta(days=1)).isoformat() + "T16:30:00",
    ...
    # 7. Create weekly_training_plan.json
    sessions = [
        # Session 1 (complete): Finishing Focus — 60 min
        {
            "day_number": 1,
            ...
            "completed": True,
            "completed_date": monday.isoformat() + "T16:30:00"
        },
        # Session 2 (complete): First Touch + Passing — 55 min
        {
            "day_number": 2,
            ...
            "completed": True,
            "completed_date": (monday + timedelta(days=1)).isoformat() + "T17:25:00"
        },
        # Session 3 (incomplete): 1v1 Attacking — 60 min
        {
            "day_number": 3,
        ...
        # Session 4 (incomplete): Weak Foot + Technical — 50 min
        {
            "day_number": 4,
